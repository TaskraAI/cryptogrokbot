...
- Edit .env LIVE flags.
- Tell Grok Bot to invent `chief:APPROVE`. Grok waits for Chief or Taskra. Chief may deputy-approve routine queued gems when Taskra is away. Paper Scout still auto-buys.
